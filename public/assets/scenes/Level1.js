export default class Level1 extends Phaser.Scene {
    ...
    */
		...
		// GAMEBOARD GAME OBJECTS
		this.boardbg = this.add.image(21, 91, 'boardbg').setOrigin(0,0)
		
		this.box_blank1 = this.add.image(32, 102, 'box_blank')
			.setOrigin(0,0)
			.setInteractive() // enable clickable
			.setDataEnabled() // enable data to be sent to game objects
		...
		this.box_blank8 = this.add.image(74, 186, 'box_blank')
			.setOrigin(0,0) // use setOrigin to be more specific with location of game object
			.setInteractive() // enable clickable
			.setDataEnabled() // enable data to be sent to game objects
		...
		// DISPLAY WINNING GAME OBJECTS
		this.playagainBtn = this.add.image(this.game.config.width / 2, 400, 'playagain').setDepth(5).setInteractive() // like z-index
	...
	clickedBox() {
		...
		this.input.on('gameobjectdown', (pointer, gameObject) => {
			if(this.gameBoard[1] == 'a' && gameObject.data.get('box_number') == 1){
				...
				gameObject.destroy()
				this.box_blank2 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank3 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank4 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank5 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank6 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank7 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank8 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
				...
				gameObject.destroy()
				this.box_blank9 = this.add.image(gameObject.x, gameObject.y, this.currentPlayer ? 'box_xblue' : 'box_ored').setOrigin(0,0)
	...
	checkWin() {
		...
		if (this.gameBoard[1] == this.gameBoard[2] && this.gameBoard[2] == this.gameBoard[3]) {
			this.winningAnimation(player)
		} else if (this.gameBoard[4] == this.gameBoard[5] && this.gameBoard[5] == this.gameBoard[6]) {
			this.winningAnimation(player)
		} else if (this.gameBoard[7] == this.gameBoard[8] && this.gameBoard[8] == this.gameBoard[9]) {
			this.winningAnimation(player)
			...
			this.winningAnimation(player)
		} else if (this.gameBoard[3] == this.gameBoard[6] && this.gameBoard[6] == this.gameBoard[9]) {
			this.winningAnimation(player)
		} else if (this.gameBoard[1] == this.gameBoard[5] && this.gameBoard[5] == this.gameBoard[9]) {
			this.winningAnimation(player)
		} else if (this.gameBoard[3] == this.gameBoard[5] && this.gameBoard[5] == this.gameBoard[7]) {
			this.winningAnimation(player)
		} else if (
			this.gameBoard[1] != 'a' &&
			this.gameBoard[2] != 'b' &&
